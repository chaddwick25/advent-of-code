...
for(let index = 0; index < coords.length; index++){
    ...
    // forward
        ...
        if(aim > 0){
            depth += aim * Number(values[1])
        }
    }
}

console.log(`After following these new instructions, you would have a horizontal position of ${horizontal} and a depth of ${depth}. (Multiplying these produces ${horizontal * depth}.)`);
